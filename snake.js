var Snake = (function() {
    ...
    function comida() {
        ...
        this.colocar = function() {
            ...
            color_comida=this.conseguirColor();
            posicion_x = posicionAleatoria[0];
            posicion_y = posicionAleatoria[1];
        }

        this.conseguirColor = function () {
    ...
    function serpiente() {
        ...
        this.mover = function() {
            ...
            if (comida.colision(nuevaPosicion[0], nuevaPosicion[1])) {
                color_serpiente=comida.obtenerColor();
                color_fondo = obtenerColorFondo();
                comida.colocar();
    ...
    function fin_juego() {
        ...
        ctx.fillStyle = '#000';
        ctx.fillText('Marcelo Gonzalez Diego Hernán', x, y+25);
        ctx.fillText('Codigo : 1315220467', x, y+45);
        ctx.fillText('Presiona R, para reiniciar', x, y + 80);
    ...
    function ciclo() {
        ...
        ctx.textAlign = 'center';
        ctx.fillStyle = '#F00';
        var time = intervalo * 200 / 1000;
        ctx.fillText(Math.round(time), $canvas.width()-20, 23);
        serpiente.dibujar();
        comida.mostrar();
